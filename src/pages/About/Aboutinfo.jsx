...
function Aboutinfo(props) {
    return (
      ...
      <p className='paraa'>JUST PLAY MUSIC Production have stepped ahead to help several artists to showcase their talent and reach to a broader platform of audience.
JUST PLAY MUSIC Production is a Punjabi , hindi music production company led by the team members namely, Aksh Sawarne (Owner), Guru Mankan (Co-Owner), Himanshu Sahu (Producer ,Head  Management) and Karan Juneja (Manager). Commencing our projects from 2019, we have come so far to establish our name in the field of music production. We have an aim to give favourable opportunities to new talents. Keeping this goal, we have launched several shining stars in the field of music.</p><p className='paraa'>
